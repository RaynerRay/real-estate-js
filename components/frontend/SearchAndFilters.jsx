...
export default function SearchandFilters() {
 ...
 <button
  ...
  <button
    type="submit"
    className="flex-1 md:flex-initial flex items-center justify-center px-4 py-4 md:py-3 bg-green-600 text-white rounded-lg hover:bg-green-600 w-full md:w-auto"
  >
